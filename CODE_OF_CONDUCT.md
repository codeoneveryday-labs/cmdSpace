...
cmdSpace is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about cmdSpace. Take off-topic conversations elsewhere.
...
If you see a violation — or experience one — email **crynta.dev@gmail.com** with subject `[cmdSpace conduct]`. Include links and context.
