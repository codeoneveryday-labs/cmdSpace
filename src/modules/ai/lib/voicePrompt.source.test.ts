...
describe("voice prompt refinement", () => {
  it("asks the model to compile spoken requests into Space task kinds", () => {
    ...
    expect(source).toContain("cmdSpace Space");
    expect(source).toContain("Recent Space task drafts");
