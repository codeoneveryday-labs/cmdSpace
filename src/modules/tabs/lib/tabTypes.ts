...
export type Tab = TerminalTab | EditorTab | MarkdownTab | AiDiffTab | GitDiffTab | GitHistoryTab | ArchitectureTab | GitCommitFileDiffTab;
export type TabPatch = Partial<{ title: string; cwd: string; diagram: ArchitectureDiagram; path: string; dirty: boolean }>;
