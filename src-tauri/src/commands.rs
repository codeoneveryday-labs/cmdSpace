...
macro_rules! cmdspace_commands {
    () => {
        tauri::generate_handler![
            ...
            orchestration::commands::orchestration_finalize_run,
            ...
            orchestration::commands::orchestration_breaker_beat,
            ...
            orchestration::commands::orchestration_memory_search,
            orchestration::commands::orchestration_board_note,
            orchestration::commands::orchestration_spawn_list,
            orchestration::commands::orchestration_spawn_claim,
            // PTY
            pty::pty_open,
            pty::pty_write,
            pty::pty_trace_input,
