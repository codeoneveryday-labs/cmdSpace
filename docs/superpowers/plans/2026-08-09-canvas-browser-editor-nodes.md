...
- [ ] **Step 3: Add minimal diagram fields and node-kind rules**
...
Use `@tauri-apps/plugin-dialog` to choose one file. Render a labeled empty state
when `path` is absent and otherwise render:
...
- [ ] **Step 1: Write failing toolbar/render tests**
...
- [ ] **Step 2: Run focused and complete frontend proof**
...
- [ ] **Step 3: Run native release proof**
