# Contributing to cmdSpace

cmdSpace is a solo-maintained project with a strong product direction. Contributions are welcome, but **alignment matters more than volume**.
...
- cmdSpace is maintained by [@codeoneveryday-labs](https://github.com/codeoneveryday-labs).
...
cmdSpace positions itself as **lightweight, fast, production-grade**. Every PR is reviewed against:
...
- cmdSpace is not trying to be a full IDE replacement (VS Code, Cursor, Zed).
